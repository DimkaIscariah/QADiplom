...
public class PaymentPage {
    ...
    public void errorField() {
        errorField.shouldBe(visible, Duration.ofSeconds(15));
    }
    ...
    public void errorYearCard() {
        errorYearCard.shouldBe(visible, Duration.ofSeconds(15));
    }

    public void emptyField() {
        emptySpase.shouldBe(visible, Duration.ofSeconds(15));
    }
}
